...
open Result for
Select m.nombre,m.veterinario,m.fecha,m.descripcion,m.nota_adicional,de.direccion_exacta,d.distrito,em.estado_mascota,
e.enfermedad,r.raza,tm.tipo_mascota,t.tamanio,p.nombre as nombre_mascota, p.num_telefono_1
from mascota m
