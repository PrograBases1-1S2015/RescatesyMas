...
<div class="main">
	...
	<div class="busqueda">
            ...
            <legend style="color:white">Formulario de Registro</legend>
               <label style="color:white">Nombre de usuario del adoptante:</label>
                        <input id="campoFormulario" name="dato" type="text" value="Nombre Completo"/>
                <label style="color:white">Mascota:</label>
                       			<select name="tamaño">
